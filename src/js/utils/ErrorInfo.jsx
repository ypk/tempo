    ...
    return (
            ...
            <div className="row">
                <div className="col-6 my-5 mx-auto">
                    <div className="alert alert-danger d-flex align-items-center" role="alert">
                        <svg className="ms-3 me-5" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		c-13.9,0-25.2-11.3-25.2-25.2c0-13.9,11.3-25.2,25.2-25.2s25.2,11.3,25.2,25.2S258.125,410.113,244.225,410.113z"/>
                        ...
                        <div className="py-2">
                            ...
                            <p className="m-0">An error occurred while trying to fetch Pokemon Info.</p>
